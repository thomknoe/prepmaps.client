...
**_This is the client section of the app. Check out the server section <a href="https://github.com/tomknoe/prepmaps.Node.js" target="_blank">here</a>._**
...
- Open command line or terminal and clone both this repo and <a href="https://github.com/tomknoe/prepmaps.server" target="_blank">the backend repo</a> into your desired directory.
